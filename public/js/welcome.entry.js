...
/***/ function(module, exports, __webpack_require__) {
	...
	var Welcome = React.createClass({
		...
		componentWillMount: function componentWillMount() {
			...
			pollsRequest.setRequestHeader('Authorization', 'Basic ' + btoa(localStorage.getItem('sessionId') + ':'));
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					'What poll are you looking for?'
				),
				React.createElement(
					'div',
					null,
					React.createElement(PollingSelector, { polls: this.state.polls, onSubmit: this.handleSubmit })
				),
				React.createElement(
					'div',
					{ className: 'text-center' },
	...
	var PollingSelector = React.createClass({
		...
		auth: function auth(e) {
			...
			if (this.state.poll && this.refs.pass.value) {
				...
				req.setRequestHeader('Authorization', 'Basic ' + btoa(this.state.poll + ':' + this.refs.pass.value));
		...
		render: function render() {
			return React.createElement(
				'div',
				null,
				React.createElement(PollingOptions, { polls: this.props.polls, onSubmit: this.setPoll }),
				React.createElement('br', null),
				React.createElement(
					'form',
					{ onSubmit: this.auth, style: { display: "inline" } },
					React.createElement(
						'div',
						{ className: 'form-group input-group' },
						React.createElement('input', { ref: 'pass', type: 'password', className: 'form-control', placeholder: 'Enter passcode...' }),
						React.createElement(
							'span',
							{ className: 'input-group-btn' },
							React.createElement('input', { type: 'submit', className: 'btn btn-default', value: 'GO!', onClick: this.auth })
						)
					)
				)
			);
		...
		render: function render() {
			if (this.props.polls) {
				var polls = this.props.polls.map(function (poll) {
					return React.createElement(
						'option',
						{ key: poll._id, value: poll._id },
						poll.name
					);
				});
				return React.createElement(
					'select',
					{ ref: 'sel', className: 'form-control', onChange: this.onChange },
					React.createElement(
						'option',
						{ key: 'default', value: '' },
						'Make a selection...'
	...
	ReactDOM.render(React.createElement(Welcome, null), document.getElementById('content'));
